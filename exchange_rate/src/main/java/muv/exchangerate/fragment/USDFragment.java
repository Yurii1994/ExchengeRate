...
import muv.exchangerate.NetworkStateReceiver;
import muv.exchangerate.R;
import muv.exchangerate.adapter.USDAdapter;
import muv.exchangerate.data.DataAllBank;

public class USDFragment extends AbstractTabFragment
{
    ...
    public static USDFragment getInstance(Context context, List<DataAllBank> list)
    {
        Bundle args = new Bundle();
        USDFragment fragment = new USDFragment();
        fragment.setArguments(args);
        fragment.setContext(context);
        fragment.setTitle(context.getString(R.string.usd));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new USDAdapter(list, context);
    ...
    public void onResume() {
        super.onResume();
        refreshData(MainActivity.listUSD);
    }
}