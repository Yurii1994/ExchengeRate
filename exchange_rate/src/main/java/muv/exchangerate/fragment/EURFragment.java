...
import muv.exchangerate.adapter.EURAdapter;
import muv.exchangerate.data.DataAllBank;


public class EURFragment extends AbstractTabFragment
{
    private static final int LAYOUT = R.layout.fragment_usd_eur_rub;

    private EURAdapter adapter;
    ...
    public static EURFragment getInstance(Context context, List<DataAllBank> list) {
        Bundle bundle = new Bundle();
        EURFragment fragment = new EURFragment();
        fragment.setArguments(bundle);
        fragment.setContext(context);
        fragment.setTitle(context.getString(R.string.eur));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        final RecyclerView recyclerView = (RecyclerView)view.findViewById(R.id.recycler_usd_eur_rub);
        recyclerView.setLayoutManager(new LinearLayoutManager(context));
        adapter = new EURAdapter(list, context);
    ...
    public void onResume() {
        super.onResume();
        refreshData(MainActivity.listEUR);
    }
}
